...
| 17 | Waterborne. This item floats on water and other liquids. Its bearer has advantage on Strength ([Athletics](Mechanics/CLI/rules/skills.md#Athletics)) checks to swim. |
