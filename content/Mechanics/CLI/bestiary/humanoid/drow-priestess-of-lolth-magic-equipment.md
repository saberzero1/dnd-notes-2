...
- **Armor Class** 19 ([+3 scale mail](Mechanics/CLI/items/drow-3-armor-mm.md))
...
***Special Equipment.*** The drow wears [+3 scale mail](Mechanics/CLI/items/drow-3-armor-mm.md). This armor loses its enhancement bonuses permanently if it is exposed to sunlight for 1 hour or longer.
