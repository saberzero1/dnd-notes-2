...
```ad-statblock
title: Booyahg Whip
![](Mechanics/CLI/bestiary/humanoid/token/booyahg-whip-vgm.webp#token)
...
***Khurgorbaeyag's Gift.*** Khurgorbaeyag saw fit to gift this goblin with powers that enable it to dominate others. The goblin has `1d3` other [goblins](Mechanics/CLI/bestiary/humanoid/goblin.md) that slavishly obey its orders.
