...
```ad-statblock
title: Champion
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/refs/heads/main/img/ValdaCaptain/Tokens/Champion.webp#token)
*Small or Medium humanoid (Cohort), Neutral*

- **Armor Class** 18 
- **Hit Points** 6 plus six times your Captain level (the champion has a number of Hit Dice [d8s] equal to your Captain level)  (6 plus six times your Captain level (the champion has a number of Hit Dice [d8s] equal to your Captain level))
- **Speed** 30 ft.
...
***Level 5.*** Martial Excellence. The champion has a +1 bonus to its attack and damage rolls. This bonus increases to +2 at Captain level 9, and +3 at Captain level 13.

***Level 13.*** Indomitable (2/Day). The champion rerolls a failed saving throw with a bonus equal to your Captain level.
