...
![](Mechanics/CLI/bestiary/humanoid/token/drow-inquisitor-mpmm.webp#token)
...
- **Skills** [Insight](Mechanics/CLI/rules/skills.md#Insight) +10, [Perception](Mechanics/CLI/rules/skills.md#Perception) +10, [Religion](Mechanics/CLI/rules/skills.md#Religion) +8, [Stealth](Mechanics/CLI/rules/skills.md#Stealth) +7
...
**At will:** [dancing lights](Mechanics/CLI/spells/dancing-lights-xphb.md), [detect magic](Mechanics/CLI/spells/detect-magic-xphb.md), [message](Mechanics/CLI/spells/message-xphb.md), [thaumaturgy](Mechanics/CLI/spells/thaumaturgy-xphb.md)

**1/day each:** [clairvoyance](Mechanics/CLI/spells/clairvoyance-xphb.md), [darkness](Mechanics/CLI/spells/darkness-xphb.md), [detect thoughts](Mechanics/CLI/spells/detect-thoughts-xphb.md), [dispel magic](Mechanics/CLI/spells/dispel-magic-xphb.md), [faerie fire](Mechanics/CLI/spells/faerie-fire-xphb.md), [levitate](Mechanics/CLI/spells/levitate-xphb.md) (self only), [silence](Mechanics/CLI/spells/silence-xphb.md), [suggestion](Mechanics/CLI/spells/suggestion-xphb.md), [true seeing](Mechanics/CLI/spells/true-seeing-xphb.md)
