...
```ad-statblock
title: Worg
![](Mechanics/CLI/bestiary/monstrosity/token/worg.webp#token)
...
***Keen Hearing and Smell.*** The worg has advantage on Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception)) checks that rely on hearing or smell.
