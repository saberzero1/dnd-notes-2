...
```ad-statblock
title: Mock
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/refs/heads/main/img/ValdaWitch/Tokens/Mock.webp#token)
...
***Bite.*** *Melee Attack Roll:* `+3`, reach 5 ft. *Hit:* 3 (`1d4 + 1`) Piercing damage plus 2 (`1d4`) Acid damage.
