...
![](Mechanics/CLI/bestiary/monstrosity/img/hippogriff.webp#right)
...
```ad-statblock
title: Hippogriff
![](Mechanics/CLI/bestiary/monstrosity/token/hippogriff.webp#token)
...
***Keen Sight.*** The hippogriff has advantage on Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception)) checks that rely on sight.
