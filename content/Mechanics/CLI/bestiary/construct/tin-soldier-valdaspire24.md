...
```ad-statblock
title: Tin Soldier
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/refs/heads/main/img/ValdaWitch/Tokens/TinSoldier.webp#token)
...
***Bayonet.*** *Melee Attack Roll:* `+4`, reach 5 ft. *Hit:* 4 (`1d4 + 2`) Piercing damage.
