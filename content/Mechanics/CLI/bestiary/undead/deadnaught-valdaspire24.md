...
```ad-statblock
title: Deadnaught
*Medium undead (Thrall), Lawful Evil*

- **Armor Class** 16 
- **Hit Points** 10 plus five times your Necromancer level (the deadnaught has a number of Hit Dice [d8s] equal to your Necromancer level)  (10 plus five times your Necromancer level (the deadnaught has a number of Hit Dice [d8s] equal to your Necromancer level))
- **Speed** 30 ft.

|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
|19 (+4)|14 (+2)|16 (+3)| 7 (-2)|10 (+0)| 6 (-2)|
