...
![](Mechanics/CLI/bestiary/beast/img/swarm-of-bats.webp#right)
...
```ad-statblock
title: Swarm of Bats
![](Mechanics/CLI/bestiary/beast/token/swarm-of-bats.webp#token)
...
***Echolocation.*** The swarm can't use its blindsight while [deafened](Mechanics/CLI/rules/conditions.md#Deafened).

***Keen Hearing.*** The swarm has advantage on Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception)) checks that rely on hearing.
