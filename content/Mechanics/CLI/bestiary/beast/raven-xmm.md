...
![](Mechanics/CLI/bestiary/beast/img/raven.webp#right)
...
```ad-statblock
title: Raven
![](Mechanics/CLI/bestiary/beast/token/raven-xmm.webp#token)
...
***Mimicry.*** The raven can mimic simple sounds it has heard, such as a whisper or chitter. A hearer can discern the sounds are imitations with a successful DC 10 Wisdom ([Insight](Mechanics/CLI/rules/skills.md#Insight)) check.
