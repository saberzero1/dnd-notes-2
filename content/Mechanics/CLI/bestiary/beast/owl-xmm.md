...
![](Mechanics/CLI/bestiary/beast/img/owl.webp#right)
...
```ad-statblock
title: Owl
![](Mechanics/CLI/bestiary/beast/token/owl-xmm.webp#token)
...
***Flyby.*** The owl doesn't provoke [Opportunity Attacks](Mechanics/CLI/rules/actions.md#Opportunity%20Attack) when it flies out of an enemy's reach.
