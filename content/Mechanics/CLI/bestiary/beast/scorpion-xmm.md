...
![](Mechanics/CLI/bestiary/beast/img/scorpion.webp#right)
...
```ad-statblock
title: Scorpion
![](Mechanics/CLI/bestiary/beast/token/scorpion-xmm.webp#token)
...
- **Saving Throws** ⏤
- **Skills** ⏤
- **Senses** [Blindsight](Mechanics/CLI/rules/senses.md#Blindsight) 10 ft., passive Perception 9
- **Languages** —
- **Challenge** 0
