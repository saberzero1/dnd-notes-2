...
![](Mechanics/CLI/bestiary/beast/img/giant-goat.webp#right)
...
```ad-statblock
title: Giant Goat
![](Mechanics/CLI/bestiary/beast/token/giant-goat-xmm.webp#token)
...
***Ram.*** *Melee Attack Roll:* `+5`, reach 5 ft. *Hit:* 6 (`1d6 + 3`) Bludgeoning damage. If the target is a Large or smaller creature and the goat moved 20+ feet straight toward it immediately before the hit, the target takes an extra 5 (`2d4`) Bludgeoning damage and has the [Prone](Mechanics/CLI/rules/conditions.md#Prone) condition.
```
^statblock
