...
![](Mechanics/CLI/bestiary/beast/img/swarm-of-rats.webp#right)
...
```ad-statblock
title: Swarm of Rats
![](Mechanics/CLI/bestiary/beast/token/swarm-of-rats.webp#token)
...
***Keen Smell.*** The swarm has advantage on Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception)) checks that rely on smell.
