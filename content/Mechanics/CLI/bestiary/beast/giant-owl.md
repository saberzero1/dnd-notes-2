...
```ad-statblock
title: Giant Owl
![](Mechanics/CLI/bestiary/beast/token/giant-owl.webp#token)
*Large beast, Neutral*
...
***Keen Hearing and Sight.*** The owl has advantage on Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception)) checks that rely on hearing or sight.
