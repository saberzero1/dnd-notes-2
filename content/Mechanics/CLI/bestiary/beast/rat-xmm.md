...
![An adventurer underestimat...](Mechanics/CLI/bestiary/beast/img/rats.webp#right "An adventurer underestimates the extent of a tavern's giant rat infestation")
...
```ad-statblock
title: Rat
![](Mechanics/CLI/bestiary/beast/token/rat-xmm.webp#token)
...
***Agile.*** The rat doesn't provoke [Opportunity Attacks](Mechanics/CLI/rules/actions.md#Opportunity%20Attack) when it moves out of an enemy's reach.
