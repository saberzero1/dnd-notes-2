...
publish: true
aliases: Frog
created: 2026-03-15T01:10:08.502+01:00
modified: 2026-03-15T01:08:43.777+01:00
tags:
...
![](Mechanics/CLI/bestiary/beast/img/frog.webp#right)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](Mechanics/CLI/rules/skills.md#Perception) +1, [Stealth](Mechanics/CLI/rules/skills.md#Stealth) +3
- **Senses** [Darkvision](Mechanics/CLI/rules/senses.md#Darkvision) 30 ft., passive Perception 11
- **Languages** —
- **Challenge** 0
...
***Standing Leap.*** The frog's [Long Jump](Mechanics/CLI/rules/variant-rules/long-jump-xphb.md) is up to 10 feet and its [High Jump](Mechanics/CLI/rules/variant-rules/high-jump-xphb.md) is up to 5 feet with or without a running start.
