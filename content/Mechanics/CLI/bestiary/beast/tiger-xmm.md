...
publish: true
aliases: Tiger
created: 2026-03-15T01:10:08.512+01:00
...
```ad-statblock
title: Tiger
![](Mechanics/CLI/bestiary/beast/token/tiger-xmm.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](Mechanics/CLI/rules/skills.md#Perception) +3, [Stealth](Mechanics/CLI/rules/skills.md#Stealth) +7
...
***Rend.*** *Melee Attack Roll:* `+5`, reach 5 ft. *Hit:* 10 (`2d6 + 3`) Slashing damage. If the target is a Large or smaller creature, it has the [Prone](Mechanics/CLI/rules/conditions.md#Prone) condition.
