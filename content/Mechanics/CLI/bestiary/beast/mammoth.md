...
```ad-statblock
title: Mammoth
![](Mechanics/CLI/bestiary/beast/token/mammoth.webp#token)
...
***Trampling Charge.*** If the mammoth moves at least 20 feet straight toward a creature and then hits it with a gore attack on the same turn, that target must succeed on a DC 18 Strength saving throw or be knocked [prone](Mechanics/CLI/rules/conditions.md#Prone). If the target is [prone](Mechanics/CLI/rules/conditions.md#Prone), the mammoth can make one stomp attack against it as a bonus action.
