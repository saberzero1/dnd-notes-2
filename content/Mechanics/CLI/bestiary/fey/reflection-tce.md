...
```ad-statblock
title: Reflection
![](Mechanics/CLI/bestiary/fey/token/reflection-tce.webp#token)
...
***Shadow Stealth.*** While in dim light or darkness, the reflection can take the [Hide](Mechanics/CLI/rules/actions.md#Hide) action as a bonus action. Its stealth bonus is also improved to +6.
