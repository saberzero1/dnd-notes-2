...
publish: true
aliases: Nilbog
created: 2026-03-15T01:10:08.557+01:00
modified: 2026-03-15T01:08:43.839+01:00
tags:
...
```ad-statblock
title: Nilbog
![](Mechanics/CLI/bestiary/fey/token/nilbog-mpmm.webp#token)
...
***Nilbogism.*** Any creature that attempts to damage the nilbog must first succeed on a DC 12 Charisma saving throw or be [charmed](Mechanics/CLI/rules/conditions.md#Charmed) until the end of the creature's next turn. A creature [charmed](Mechanics/CLI/rules/conditions.md#Charmed) in this way must use its action praising the nilbog.
...
**At will:** [mage hand](Mechanics/CLI/spells/mage-hand-xphb.md), [Tasha's hideous laughter](Mechanics/CLI/spells/tashas-hideous-laughter-xphb.md)

## Bonus Actions

***Nimble Escape.*** The nilbog takes the [Disengage](Mechanics/CLI/rules/actions.md#Disengage) or [Hide](Mechanics/CLI/rules/actions.md#Hide) action.
