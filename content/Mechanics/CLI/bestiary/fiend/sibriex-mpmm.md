...
publish: true
aliases: Sibriex
created: 2026-03-15T01:10:08.570+01:00
modified: 2026-03-15T01:08:43.853+01:00
tags:
...
```ad-statblock
title: Sibriex
![](Mechanics/CLI/bestiary/fiend/token/sibriex-mpmm.webp#token)
...
- **Skills** [Arcana](Mechanics/CLI/rules/skills.md#Arcana) +13, [History](Mechanics/CLI/rules/skills.md#History) +13, [Perception](Mechanics/CLI/rules/skills.md#Perception) +13
...
***Warp Creature.*** The sibriex targets up to three creatures it can see within 120 feet of it. Each target must make a DC 20 Constitution saving throw. On a successful save, a creature becomes immune to this sibriex's Warp Creature. On a failed save, the target is [poisoned](Mechanics/CLI/rules/conditions.md#Poisoned), which causes it to also gain 1 level of [exhaustion](Mechanics/CLI/rules/conditions.md#Exhaustion). While [poisoned](Mechanics/CLI/rules/conditions.md#Poisoned) in this way, the target must repeat the saving throw at the start of each of its turns. Three successful saves against the poison end it, and ending the poison removes any levels of [exhaustion](Mechanics/CLI/rules/conditions.md#Exhaustion) caused by it. Each failed save causes the target to gain another level of [exhaustion](Mechanics/CLI/rules/conditions.md#Exhaustion). Once the target reaches 6 levels of [exhaustion](Mechanics/CLI/rules/conditions.md#Exhaustion), it dies and instantly transforms into a living [manes](Mechanics/CLI/bestiary/fiend/manes.md) under the sibriex's control. The transformation of the body can be undone only by a [wish](Mechanics/CLI/spells/wish-xphb.md) spell.
...
**At will:** [command](Mechanics/CLI/spells/command-xphb.md), [dispel magic](Mechanics/CLI/spells/dispel-magic-xphb.md), [hold monster](Mechanics/CLI/spells/hold-monster-xphb.md)
