...
![](Mechanics/CLI/bestiary/fiend/token/fiendish-spirit-xphb.webp#token)
*Large fiend, Neutral*

- **Armor Class** (12 + the spell's level)
- **Hit Points** 50 (Demon only) or 40 (Devil only) or 60 (Yugoloth only) + 15 for each spell level above 6  (50 (Demon only) or 40 (Devil only) or 60 (Yugoloth only) + 15 for each spell level above 6)
