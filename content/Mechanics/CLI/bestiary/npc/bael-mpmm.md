...
modified: 2026-03-15T01:08:43.924+01:00
tags:
...
```ad-statblock
title: Bael
![](Mechanics/CLI/bestiary/npc/token/bael-mpmm.webp#token)
...
- **Skills** [Intimidation](Mechanics/CLI/rules/skills.md#Intimidation) +13, [Perception](Mechanics/CLI/rules/skills.md#Perception) +13, [Persuasion](Mechanics/CLI/rules/skills.md#Persuasion) +13
- **Senses** [truesight](Mechanics/CLI/rules/senses.md#Truesight) 120 ft., passive Perception 23
...
***Dread.*** Any creature, other than a devil, that starts its turn within 10 feet of Bael must succeed on a DC 22 Wisdom saving throw or be [frightened](Mechanics/CLI/rules/conditions.md#Frightened) of him until the start of its next turn. A creature succeeds on this saving throw automatically if Bael wishes it or if he is [incapacitated](Mechanics/CLI/rules/conditions.md#Incapacitated).
...
***Infernal Command.*** Each of Bael's allies within 60 feet of him can't be [charmed](Mechanics/CLI/rules/conditions.md#Charmed) or [frightened](Mechanics/CLI/rules/conditions.md#Frightened) until the end of his next turn.
...
**At will:** [alter self](Mechanics/CLI/spells/alter-self-xphb.md) (can become Medium), [charm person](Mechanics/CLI/spells/charm-person-xphb.md), [detect magic](Mechanics/CLI/spells/detect-magic-xphb.md), [invisibility](Mechanics/CLI/spells/invisibility-xphb.md), [major image](Mechanics/CLI/spells/major-image-xphb.md)

**3/day each:** [dispel magic](Mechanics/CLI/spells/dispel-magic-xphb.md), [fly](Mechanics/CLI/spells/fly-xphb.md), [suggestion](Mechanics/CLI/spells/suggestion-xphb.md), [wall of fire](Mechanics/CLI/spells/wall-of-fire-xphb.md)
