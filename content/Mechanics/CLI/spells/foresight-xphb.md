...
You touch a willing creature and bestow a limited ability to see into the immediate future. For the duration, the target has [Advantage](Mechanics/CLI/rules/variant-rules/advantage-xphb.md) on [D20 Tests](Mechanics/CLI/rules/variant-rules/d20-test-xphb.md), and other creatures have [Disadvantage](Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on attack rolls against it. The spell ends early if you cast it again.
