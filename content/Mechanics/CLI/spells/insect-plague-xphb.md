...
Swarming locusts fill a 20-foot-radius [Sphere](Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) centered on a point you choose within range. The [Sphere](Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) remains for the duration, and its area is [Lightly Obscured](Mechanics/CLI/rules/variant-rules/lightly-obscured-xphb.md) and [Difficult Terrain](Mechanics/CLI/rules/variant-rules/difficult-terrain-xphb.md).
