...
You call forth a Dragon spirit. It manifests in an unoccupied space that you can see within range and uses the [Draconic Spirit](Mechanics/CLI/bestiary/dragon/draconic-spirit-xphb.md) stat block. The creature disappears when it drops to 0 [Hit Points](Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) or when the spell ends.
