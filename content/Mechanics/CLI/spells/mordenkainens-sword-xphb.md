...
On your later turns, you can take a [Bonus Action](Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md) to move the sword up to 30 feet to a spot you can see and repeat the attack against the same target or a different one.
