...
You unleash a storm of flashing light and raging thunder in a 10-foot-radius, 40-foot-high [Cylinder](Mechanics/CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md) centered on a point you can see within range. While in this area, creatures have the [Blinded](Mechanics/CLI/rules/conditions.md#Blinded) and [Deafened](Mechanics/CLI/rules/conditions.md#Deafened) conditions, and they can't cast spells with a Verbal component.
