...
tags:
  ...
  - ttrpg-cli/spell/feat/boon-of-siberys/mark-of-sentinel
...
Until the spell ends, one willing creature you touch has [Immunity](Mechanics/CLI/rules/variant-rules/immunity-xphb.md) to Psychic damage and the [Charmed](Mechanics/CLI/rules/conditions.md#Charmed) condition. The target is also unaffected by anything that would sense its emotions or alignment, read its thoughts, or magically detect its location, and no spell—not even [Wish](Mechanics/CLI/spells/wish-xphb.md)—can gather information about the target, observe it remotely, or control its mind.
