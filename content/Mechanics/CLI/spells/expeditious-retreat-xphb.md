...
You take the [Dash](Mechanics/CLI/rules/actions.md#Dash) action, and until the spell ends, you can take that action again as a [Bonus Action](Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md).
