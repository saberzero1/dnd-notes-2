...
Nonflammable grease covers the ground in a 10-foot square centered on a point within range and turns it into [Difficult Terrain](Mechanics/CLI/rules/variant-rules/difficult-terrain-xphb.md) for the duration.
