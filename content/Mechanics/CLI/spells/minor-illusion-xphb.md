...
tags:
  ...
  - ttrpg-cli/spell/optfeature/circus-performer
...
If a creature takes a [Study](Mechanics/CLI/rules/actions.md#Study) action to examine the sound or image, the creature can determine that it is an illusion with a successful Intelligence ([Investigation](Mechanics/CLI/rules/skills.md#Investigation)) check against your spell save DC. If a creature discerns the illusion for what it is, the illusion becomes faint to the creature.
