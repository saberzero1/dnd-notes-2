...
![](Mechanics/CLI/backgrounds/img/merchant.webp#right)

- **Ability Scores.** Constitution, Intelligence, Charisma  
- **Feat.** [Lucky](Mechanics/CLI/feats/lucky-xphb.md)  
- **Skill Proficiencies.** [Animal Handling](Mechanics/CLI/rules/skills.md#Animal%20Handling), [Persuasion](Mechanics/CLI/rules/skills.md#Persuasion)  
- **Tool Proficiency.** [Navigator's Tools](Mechanics/CLI/items/navigators-tools-xphb.md)  
- **Equipment.** Choose A or B: (A) [Navigator's Tools](Mechanics/CLI/items/navigators-tools-xphb.md), [2 Pouches](Mechanics/CLI/items/pouch-xphb.md), [Traveler's Clothes](Mechanics/CLI/items/travelers-clothes-xphb.md), 22 GP; or (B) 50 GP  
