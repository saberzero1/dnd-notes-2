...
- **Skill Proficiencies.** [Investigation](Mechanics/CLI/rules/skills.md#Investigation), [Perception](Mechanics/CLI/rules/skills.md#Perception)  
- **Tool Proficiency.** [Calligrapher's Supplies](Mechanics/CLI/items/calligraphers-supplies-xphb.md)  
- **Equipment.** Choose A or B: (A) [Calligrapher's Supplies](Mechanics/CLI/items/calligraphers-supplies-xphb.md), [Fine Clothes](Mechanics/CLI/items/fine-clothes-xphb.md), [Lamp](Mechanics/CLI/items/lamp-xphb.md), [Oil](Mechanics/CLI/items/oil-xphb.md) (3 flasks), [Parchment](Mechanics/CLI/items/parchment-xphb.md) (12 sheets), 23 GP; or (B) 50 GP  
