...
![](Mechanics/CLI/backgrounds/img/house-jorasco-heir.webp#right)

- **Ability Scores.** Dexterity, Constitution, Wisdom  
- **Feat.** [Mark of Healing](Mechanics/CLI/feats/mark-of-healing-efa.md)  
- **Skill Proficiencies.** [Medicine](Mechanics/CLI/rules/skills.md#Medicine) and [Stealth](Mechanics/CLI/rules/skills.md#Stealth)  
- **Tool Proficiencies.** [Herbalism Kit](Mechanics/CLI/items/herbalism-kit-xphb.md)  
- **Equipment.** Choose A or B: (A) [Herbalism Kit](Mechanics/CLI/items/herbalism-kit-xphb.md), [Fine Clothes](Mechanics/CLI/items/fine-clothes-xphb.md), [Healer's Kit](Mechanics/CLI/items/healers-kit-xphb.md), 25 GP; or (B) 50 GP  
