...
When you create a sidekick, you choose the class it will have for the rest of its career: [Expert](Mechanics/CLI/classes/expert-sidekick-tce.md), [Spellcaster](Mechanics/CLI/classes/spellcaster-sidekick-tce.md), or [Warrior](Mechanics/CLI/classes/warrior-sidekick-tce.md). If a sidekick class contains a choice, you may make the choice or let the players make it.
...
If the sidekick drops to 0 hit points and isn't killed outright, it falls [unconscious](Mechanics/CLI/rules/conditions.md#Unconscious) and subsequently makes death saving throws, just like a player character.
