---
publish: true
aliases: "Downtime Activity: Religious Service"
...
At the end of the required time, the character chooses to make either an Intelligence ([Religion](Mechanics/CLI/rules/skills.md#Religion)) check or a Charisma ([Persuasion](Mechanics/CLI/rules/skills.md#Persuasion)) check. The total of the check determines the benefits of service, as shown on the Religious Service table.

![Religious Service](Mechanics/CLI/tables/religious-service-xge.md)
...
![Religious Service Complications](Mechanics/CLI/tables/religious-service-complications-xge.md)