...
To determine how much money a character earns, the character makes an ability check: Strength ([Athletics](Mechanics/CLI/rules/skills.md#Athletics)), Dexterity ([Acrobatics](Mechanics/CLI/rules/skills.md#Acrobatics)), Intelligence using a set of tools, Charisma ([Performance](Mechanics/CLI/rules/skills.md#Performance)), or Charisma using a [musical instrument](Mechanics/CLI/items/musical-instrument-xphb.md). Consult the Wages table to see how much money is generated according to the total of the check.

![Work; Wages](Mechanics/CLI/tables/work-wages-xge.md)
...
![Work Complications](Mechanics/CLI/tables/work-complications-xge.md)