...
The Spell Points by Level table applies to [bards](Mechanics/CLI/classes/bard-xphb.md), [clerics](Mechanics/CLI/classes/cleric-xphb.md), [druids](Mechanics/CLI/classes/druid-xphb.md), [sorcerers](Mechanics/CLI/classes/sorcerer-xphb.md), and [wizards](Mechanics/CLI/classes/wizard-xphb.md). For a [paladin](Mechanics/CLI/classes/paladin-xphb.md) or [ranger](Mechanics/CLI/classes/ranger-xphb.md), halve the character's level in that class and then consult the table. For a [fighter (Eldritch Knight)](Mechanics/CLI/classes/fighter-xphb.md) or [rogue (Arcane Trickster)](Mechanics/CLI/classes/rogue-xphb.md), divide the character's level in that class by three.
...
![Variant: Spell Points; Spell Point Cost](Mechanics/CLI/tables/variant-spell-points-spell-point-cost.md)

![Variant: Spell Points; Spell Points by Level](Mechanics/CLI/tables/variant-spell-points-spell-points-by-level.md)