...
To attempt a crime, the character makes three checks: Dexterity ([Stealth](Mechanics/CLI/rules/skills.md#Stealth)), Dexterity using [thieves' tools](Mechanics/CLI/items/thieves-tools-xphb.md), and the player's choice of Intelligence ([Investigation](Mechanics/CLI/rules/skills.md#Investigation)), Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception)), or Charisma ([Deception](Mechanics/CLI/rules/skills.md#Deception)).
...
![Crime; Loot Value](Mechanics/CLI/tables/crime-loot-value-xge.md)
...
![Crime Complications](Mechanics/CLI/tables/crime-complications-xge.md)