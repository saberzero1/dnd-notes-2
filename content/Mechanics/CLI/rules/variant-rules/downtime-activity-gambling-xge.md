...
The character makes three checks: Wisdom ([Insight](Mechanics/CLI/rules/skills.md#Insight)), Charisma ([Deception](Mechanics/CLI/rules/skills.md#Deception)), and Charisma ([Intimidation](Mechanics/CLI/rules/skills.md#Intimidation)). If the character has proficiency with an appropriate [gaming set](Mechanics/CLI/items/gaming-set-xphb.md), that tool proficiency can replace the relevant skill in any of the checks. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Gambling Results table to see how the character did.

![Gambling Results](Mechanics/CLI/tables/gambling-results-xge.md)
...
![Gambling Complications](Mechanics/CLI/tables/gambling-complications-xge.md)