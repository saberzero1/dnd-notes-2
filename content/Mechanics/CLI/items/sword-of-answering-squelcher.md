---
publish: true
aliases: Sword of Answering (Squelcher)
...
*Weapon ([longsword](Mechanics/CLI/items/longsword-xphb.md)), major, legendary (requires attunement by a neutral evil creature)*  
