...
While holding this [lyre](Mechanics/CLI/items/lyre-xphb.md), you can cast [mending](Mechanics/CLI/spells/mending-xphb.md) as an action. You can also play the [lyre](Mechanics/CLI/items/lyre-xphb.md) as a reaction when an object or a structure you can see within 300 feet of you takes damage, causing it to be immune to that damage and any further damage of the same type until the start of your next turn.
