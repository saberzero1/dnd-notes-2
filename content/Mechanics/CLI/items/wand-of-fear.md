...
While holding the wand, you can use an action to expend 1 charge and command another creature to flee or grovel, as with the [command](Mechanics/CLI/spells/command-xphb.md) spell (save DC 15).
