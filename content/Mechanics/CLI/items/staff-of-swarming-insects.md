...
This staff has 10 charges and regains `1d6 + 4` expended charges daily at dawn. If you expend the last charge, roll a `d20`. On a 1, a [swarm of insects](Mechanics/CLI/bestiary/beast/swarm-of-insects.md) consumes and destroys the staff, then disperses.

## Spells

While holding the staff, you can use an action to expend some of its charges to cast one of the following spells from it, using your spell save DC: [giant insect](Mechanics/CLI/spells/giant-insect-xphb.md) (4 charges) or [insect plague](Mechanics/CLI/spells/insect-plague-xphb.md) (5 charges).
