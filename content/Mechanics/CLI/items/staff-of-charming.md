...
While holding this staff, you can use an action to expend 1 of its 10 charges to cast [charm person](Mechanics/CLI/spells/charm-person-xphb.md), [command](Mechanics/CLI/spells/command-xphb.md), or [comprehend languages](Mechanics/CLI/spells/comprehend-languages-xphb.md) from it using your spell save DC. The staff can also be used as a magic quarterstaff.
