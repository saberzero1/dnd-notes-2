...
You can expend 1 charge as an action to cast [faerie fire](Mechanics/CLI/spells/faerie-fire-xphb.md) from the ring.
...
Each sphere appears in an unoccupied space you can see within 120 feet of you. The spheres last as long as you concentrate (as if [concentrating](Mechanics/CLI/rules/conditions.md#Concentration) on a spell), up to 1 minute. Each sphere sheds dim light in a 30-foot radius.
