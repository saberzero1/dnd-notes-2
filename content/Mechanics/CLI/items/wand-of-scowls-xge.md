...
The wand regains all expended charges daily at dawn. If you expend the wand's last charge, roll a `d20`. On a 1, the wand transforms into a [wand of smiles](Mechanics/CLI/items/wand-of-smiles-xge.md).
