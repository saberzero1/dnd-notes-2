...
The crook has 6 charges. While holding it, you can use an action to expend 1 or more of its charges to cast one of the following spells (save DC 18) from it: [aura of life](Mechanics/CLI/spells/aura-of-life-xphb.md) (2 charges), [aura of purity](Mechanics/CLI/spells/aura-of-purity-xphb.md) (2 charges), [banishment](Mechanics/CLI/spells/banishment-xphb.md) (1 charge), [beacon of hope](Mechanics/CLI/spells/beacon-of-hope-xphb.md) (1 charge), [mass cure wounds](Mechanics/CLI/spells/mass-cure-wounds-xphb.md) (3 charges). The crook regains `1d6` expended charges daily at dawn.
...
When the Crook was last used against Iggwilv, the Witch Queen lashed out at the artifact, infecting its magical matrix. Over the years, this curse has spread within the crook, threatening to violently pervert its ancient magic. If this occurs, the Crook of Rao, as it is currently known, is destroyed, its magical matrix inverting and exploding into a 50-foot-diameter portal. This portal functions as a permanent [gate](Mechanics/CLI/spells/gate-xphb.md) spell cast by Iggwilv. The gate then, once per round on initiative count 20, audibly speaks a fiend's name in Iggwilv's voice, doing so until the gate calls on every fiend ever banished by the Crook of Rao. If the fiend still exists, it is drawn through the gate. This process takes eighteen years to complete, at the end of which the gate becomes a permanent portal to Pazunia, the first layer of the Abyss.
...
| 26-45 | `2d4` [imps](Mechanics/CLI/bestiary/fiend/imp-xmm.md) and `2d4` [quasits](Mechanics/CLI/bestiary/fiend/quasit-xmm.md) appear. |
| 46-60 | `1d8` [succubi](Mechanics/CLI/bestiary/fiend/succubus.md)/[incubi](Mechanics/CLI/bestiary/fiend/incubus.md) appear. |
| 61-70 | `1d10` [barbed devils](Mechanics/CLI/bestiary/fiend/barbed-devil.md) and `1d10` [vrocks](Mechanics/CLI/bestiary/fiend/vrock.md) appear. |
| 71-80 | 1 [arcanaloth](Mechanics/CLI/bestiary/fiend/arcanaloth.md), 1 [night hag](Mechanics/CLI/bestiary/fiend/night-hag.md), and 1 [rakshasa](Mechanics/CLI/bestiary/fiend/rakshasa.md) appear. |
| 81-85 | 1 [ice devil](Mechanics/CLI/bestiary/fiend/ice-devil.md) and 1 [marilith](Mechanics/CLI/bestiary/fiend/marilith.md) appear. |
| 86-90 | 1 [balor](Mechanics/CLI/bestiary/fiend/balor.md) and 1 [pit fiend](Mechanics/CLI/bestiary/fiend/pit-fiend.md) appear. At the DM's discretion, a portal opens into the presence of an archdevil or demon lord instead, then closes after 5 minutes. |
