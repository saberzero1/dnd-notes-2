...
The entrance to the structure is linked to an extradimensional dwelling, as per the [Demiplane](Mechanics/CLI/spells/demiplane-xphb.md) spell. You can command the structure from inside this dwelling. If the structure is destroyed, the extradimensional dwelling is unharmed, but any creatures inside it are expelled into the unoccupied spaces nearest to the entrance.
