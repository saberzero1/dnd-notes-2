---
publish: true
aliases: Unconventional Explosives
...
When you prime a [Bomb](Mechanics/CLI/items/bomb-valdaspire24.md), you can take a [Bonus Action](Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md) to load the [Bomb](Mechanics/CLI/items/bomb-valdaspire24.md) onto a crossbow and launch it. The [Bomb](Mechanics/CLI/items/bomb-valdaspire24.md) uses the crossbow's range, but you can't use its Explode property for this attack. You can apply a formula to this [Bomb](Mechanics/CLI/items/bomb-valdaspire24.md) as normal.
