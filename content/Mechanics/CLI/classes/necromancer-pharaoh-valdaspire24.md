...
tags:
  ...
  - ttrpg-cli/subclass/necromancer/pharaoh
...
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#Pharaoh (Level 3)' class='internal-link'>Pharaoh</a></td></tr>
> <tr class="class-progression"><td class"level">4th</td><td class"pb">+2</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">5th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">6th</td><td class"pb">+3</td><td class"feature"><a href='#Mock Divinity (Level 6)' class='internal-link'>Mock Divinity</a></td></tr>
> <tr class="class-progression"><td class"level">7th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">8th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">9th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">10th</td><td class"pb">+4</td><td class"feature"><a href='#Scarab of Judgement (Level 10)' class='internal-link'>Scarab of Judgement</a></td></tr>
...
> <tr class="class-progression"><td class"level">20th</td><td class"pb">+6</td><td class"feature"><a href='#Mummy Lord [Lichdom] (Level 20)' class='internal-link'>Mummy Lord [Lichdom]</a></td></tr>
> </tbody></table>
...
### Pharaoh Spells (Level 3)

Your necromantic ambitions ensure you always have certain spells ready. When you reach a Necromancer level specified in the Pharaoh Spells table, you thereafter always have the listed spells prepared.

**Pharaoh Spells**

| Necromancer Level | Spells |
|-------------------|--------|
| 3 | [Bless](Mechanics/CLI/spells/bless-xphb.md), [Darkness](Mechanics/CLI/spells/darkness-xphb.md), [Guiding Bolt](Mechanics/CLI/spells/guiding-bolt-xphb.md), [Lesser Restoration](Mechanics/CLI/spells/lesser-restoration-xphb.md), [Thaumaturgy](Mechanics/CLI/spells/thaumaturgy-xphb.md) |
| 5 | [Bestow Curse](Mechanics/CLI/spells/bestow-curse-xphb.md), [Revivify](Mechanics/CLI/spells/revivify-xphb.md) |
| 7 | [Death Ward](Mechanics/CLI/spells/death-ward-xphb.md), [Divination](Mechanics/CLI/spells/divination-xphb.md) |
| 9 | [Insect Plague](Mechanics/CLI/spells/insect-plague-xphb.md), [Greater Restoration](Mechanics/CLI/spells/greater-restoration-xphb.md) |
^pharaoh-spells

### Holy Symbol (Level 3)

You can use a [Holy Symbol](Mechanics/CLI/items/holy-symbol-xphb.md) as a [Spellcasting Focus](Mechanics/CLI/rules/variant-rules/spellcasting-focus-xphb.md) for your Necromancer spells.
...
The Radiant damage increases by `1d6` when you reach Necromancer levels 5 (`2d6`), 11 (`3d6`), and 17 (`4d6`).

### Mock Divinity (Level 6)

You can convincingly reflect the trappings of a demigod walking the earth. When you cast [Thaumaturgy](Mechanics/CLI/spells/thaumaturgy-xphb.md), you can use any number of its effects. Additionally, you can create the following effects.

**Avatar.** At a point within range, you manifest a Huge illusory avatar for 1 minute. You determine the avatar's appearance. It mimics your movements and projects your speech in a booming voice.

**Gathering Storm.** Clouds gather and churn overhead for 1 minute. You determine the appearance of the clouds and whether they are accompanied by thunder, lightning, or a light rain.

**Sun and Moon.** You can brighten or darken the sun or moon for 1 minute. Within range, you can change [Darkness](Mechanics/CLI/rules/variant-rules/darkness-xphb.md) to [Dim Light](Mechanics/CLI/rules/variant-rules/dim-light-xphb.md) and [Dim Light](Mechanics/CLI/rules/variant-rules/dim-light-xphb.md) to [Bright Light](Mechanics/CLI/rules/variant-rules/bright-light-xphb.md), or vice versa.
