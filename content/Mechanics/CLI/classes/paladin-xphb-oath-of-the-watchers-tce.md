...
|---------------|--------|
| 3rd | [alarm](Mechanics/CLI/spells/alarm-xphb.md), [detect magic](Mechanics/CLI/spells/detect-magic-xphb.md) |
| 5th | [moonbeam](Mechanics/CLI/spells/moonbeam-xphb.md), [see invisibility](Mechanics/CLI/spells/see-invisibility-xphb.md) |
| 9th | [counterspell](Mechanics/CLI/spells/counterspell-xphb.md), [nondetection](Mechanics/CLI/spells/nondetection-xphb.md) |
| 13th | [aura of purity](Mechanics/CLI/spells/aura-of-purity-xphb.md), [banishment](Mechanics/CLI/spells/banishment-xphb.md) |
...
A turned creature must spend its turns trying to move as far away from you as it can, and it can't willingly end its move in a space within 30 feet of you. For its action, it can use only the [Dash](Mechanics/CLI/rules/actions.md#Dash) action or try to escape from an effect that prevents it from moving. If there's nowhere to move, the creature can take the [Dodge](Mechanics/CLI/rules/actions.md#Dodge) action.
