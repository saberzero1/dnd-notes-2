...
|---------------|--------|
| 3rd | [sanctuary](Mechanics/CLI/spells/sanctuary-xphb.md), [sleep](Mechanics/CLI/spells/sleep-xphb.md) |
| 5th | [calm emotions](Mechanics/CLI/spells/calm-emotions-xphb.md), [hold person](Mechanics/CLI/spells/hold-person-xphb.md) |
| 9th | [counterspell](Mechanics/CLI/spells/counterspell-xphb.md), [hypnotic pattern](Mechanics/CLI/spells/hypnotic-pattern-xphb.md) |
| 13th | [Otiluke's resilient sphere](Mechanics/CLI/spells/otilukes-resilient-sphere-xphb.md), [stoneskin](Mechanics/CLI/spells/stoneskin-xphb.md) |
| 17th | [hold monster](Mechanics/CLI/spells/hold-monster-xphb.md), [wall of force](Mechanics/CLI/spells/wall-of-force-xphb.md) |
^oath-of-redemption-spells
...
You can use your Channel Divinity to augment your presence with divine power. As a bonus action, you grant yourself a +5 bonus to Charisma ([Persuasion](Mechanics/CLI/rules/skills.md#Persuasion)) checks for the next 10 minutes.
...
Starting at 15th level, a holy presence mends your wounds in battle. You regain hit points equal to `1d6` + half your paladin level if you end your turn in combat with fewer than half of your hit points remaining and you aren't [incapacitated](Mechanics/CLI/rules/conditions.md#Incapacitated).
