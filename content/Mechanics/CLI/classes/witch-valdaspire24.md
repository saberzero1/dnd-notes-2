...
**Spell Slots.** The Witch Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](Mechanics/CLI/rules/variant-rules/long-rest-xphb.md).
...
**Spellcasting Focus.** You can use an [Arcane Focus](Mechanics/CLI/items/arcane-focus-xphb.md) as a [Spellcasting Focus](Mechanics/CLI/rules/variant-rules/spellcasting-focus-xphb.md) for your Witch spells.
...
You can take a [Bonus Action](Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md) to Cackle. When you do so, you extend the duration of one of your Hexes by 1 round, provided the target of the Hex is within the spell's range.
...
**Quick Attack.** Once per turn as an action or [Bonus Action](Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md), you can command your familiar to take the [Attack](Mechanics/CLI/rules/actions.md#Attack) action (one attack only) on its turn.
...
When a creature fails its saving throw against one of your Hexes, it has [Disadvantage](Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on saving throws it makes against your Witch spells before the end of your next turn. Similarly, if it fails its saving throw against one of your Witch spells, it has [Disadvantage](Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on saving throws it makes against your Hexes until the end of your next turn.
...
Once per turn when you cast a Hex as a [Magic](Mechanics/CLI/rules/actions.md#Magic) action, you can cast a Witch cantrip that isn't a Hex and has a casting time of an action as a part of that casting.
...
When an enemy you can see within 60 feet of yourself deals damage that causes you or an [Ally](Mechanics/CLI/rules/variant-rules/ally-xphb.md) you can see within 60 feet of yourself to become [Bloodied](Mechanics/CLI/rules/conditions.md#Bloodied), you can take a [Reaction](Mechanics/CLI/rules/variant-rules/reaction-xphb.md) to curse the enemy. Until the end of your next turn, the cursed creature has [Disadvantage](Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on [D20 Tests](Mechanics/CLI/rules/variant-rules/d20-test-xphb.md).
...
You can use this feature a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](Mechanics/CLI/rules/variant-rules/long-rest-xphb.md). You can also restore one use of it by expending a spell slot (no action required).