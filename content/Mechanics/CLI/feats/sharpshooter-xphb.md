...
**Bypass Cover.** Your ranged attacks with weapons ignore [Half Cover](Mechanics/CLI/rules/variant-rules/cover-xphb.md) and [Three-Quarters Cover](Mechanics/CLI/rules/variant-rules/cover-xphb.md).
