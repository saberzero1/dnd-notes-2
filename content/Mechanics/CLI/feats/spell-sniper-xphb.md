...
**Bypass Cover.** Your attack rolls for spells ignore [Half Cover](Mechanics/CLI/rules/variant-rules/cover-xphb.md) and [Three-Quarters Cover](Mechanics/CLI/rules/variant-rules/cover-xphb.md).
