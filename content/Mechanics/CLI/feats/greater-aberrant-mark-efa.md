...
**Improved Fortitude.** When you use the Aberrant Fortitude benefit of your Aberrant Dragonmark feat, you can roll `1d6` instead of `1d4`. You also now regain your use of Aberrant Fortitude whenever you finish a [Short](Mechanics/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](Mechanics/CLI/rules/variant-rules/long-rest-xphb.md).
