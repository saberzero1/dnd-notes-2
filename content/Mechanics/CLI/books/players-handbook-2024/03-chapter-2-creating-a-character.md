...
Write your character's level on your character sheet. Typically, a character starts at level 1 and advances in level by adventuring and gaining [Experience Points](Mechanics/CLI/rules/variant-rules/experience-points-xphb.md) (XP).
...
![Choose a Background; Ability Scores and Backgrounds](Mechanics/CLI/tables/choose-a-background-ability-scores-and-backgrounds-xphb.md)
...
Your background and class both provide starting equipment. Any coins that you gain at this step can be immediately spent on equipment from "chapter 6". In addition, you can have one [trinket](Mechanics/CLI/items/trinket-xphb.md) at no cost at the end of this chapter.
...
![Consider how your choices ...](Mechanics/CLI/books/players-handbook-2024/img/013-02-002-character-choices.webp#center "Consider how your choices combine to set your character on the path to adventure")

#### Choose a Species

Choose a species for your character. The following species options are detailed in "chapter 4": [Aasimar](Mechanics/CLI/races/aasimar-xphb.md), [Dragonborn](Mechanics/CLI/races/dragonborn-xphb.md), [Dwarf](Mechanics/CLI/races/dwarf-xphb.md), [Elf](Mechanics/CLI/races/elf-xphb.md), [Gnome](Mechanics/CLI/races/gnome-xphb.md), [Goliath](Mechanics/CLI/races/goliath-xphb.md), [Halfling](Mechanics/CLI/races/halfling-xphb.md), [Human](Mechanics/CLI/races/human-xphb.md), [Orc](Mechanics/CLI/races/orc-xphb.md), and [Tiefling](Mechanics/CLI/races/tiefling-xphb.md). Once you've chosen a species, write it on your character sheet. Then record your species' traits.

Your character's [size](Mechanics/CLI/rules/variant-rules/size-xphb.md) and [Speed](Mechanics/CLI/rules/variant-rules/speed-xphb.md) are determined by the character's species; record these in the appropriate places on your character sheet as well (you may write just the first letter of your size).
...
![Choose Languages; Rare Languages](Mechanics/CLI/tables/choose-languages-rare-languages-xphb.md)
...
![Ability Score Point Costs](Mechanics/CLI/tables/ability-score-point-costs-xphb.md)
...
![Assign Ability Scores; Standard Array by Class](Mechanics/CLI/tables/assign-ability-scores-standard-array-by-class-xphb.md)
...
![Determine Ability Modifiers; Ability Scores and Modifiers](Mechanics/CLI/tables/determine-ability-modifiers-ability-scores-and-modifiers-xphb.md)
...
![](Mechanics/CLI/books/players-handbook-2024/img/014-02-003-strength-icon.webp#center)

![Describe Appearance and Personality; Strength](Mechanics/CLI/tables/describe-appearance-and-personality-strength-xphb.md)

![](Mechanics/CLI/books/players-handbook-2024/img/015-02-004-dexterity-icon.webp#center)

![Describe Appearance and Personality; Dexterity](Mechanics/CLI/tables/describe-appearance-and-personality-dexterity-xphb.md)

![](Mechanics/CLI/books/players-handbook-2024/img/016-02-005-constitution-icon.webp#center)

![Describe Appearance and Personality; Constitution](Mechanics/CLI/tables/describe-appearance-and-personality-constitution-xphb.md)

![](Mechanics/CLI/books/players-handbook-2024/img/017-02-006-intelligence-icon.webp#center)

![Describe Appearance and Personality; Intelligence](Mechanics/CLI/tables/describe-appearance-and-personality-intelligence-xphb.md)

![](Mechanics/CLI/books/players-handbook-2024/img/018-02-007-wisdom-icon.webp#center)

![Describe Appearance and Personality; Wisdom](Mechanics/CLI/tables/describe-appearance-and-personality-wisdom-xphb.md)

![](Mechanics/CLI/books/players-handbook-2024/img/019-02-008-charisma-icon.webp#center)

![Describe Appearance and Personality; Charisma](Mechanics/CLI/tables/describe-appearance-and-personality-charisma-xphb.md)
...
![Alignments might be visual...](Mechanics/CLI/books/players-handbook-2024/img/020-02-009-alignments.webp#center "Alignments might be visualized as a grid like this—along with creatures that embody those alignments")
...
![Alignment and Personality; Personality Traits by Alignment](Mechanics/CLI/tables/alignment-and-personality-personality-traits-by-alignment-xphb.md)
...
Sometimes your DM will determine whether your character notices something without asking you to make a Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception)) check; the DM uses your Passive Perception instead. Passive Perception is a score that reflects a general awareness of your surroundings when you're not actively looking for something. Use this formula to determine your Passive Perception score:

<span class='abilityGeneric'>**Passive Perception.**</span>

Include all modifiers that apply to your Wisdom ([Perception](Mechanics/CLI/rules/skills.md#Perception)) checks. For example, if your character has a Wisdom of 15 and proficiency in the [Perception](Mechanics/CLI/rules/skills.md#Perception) skill, you have a Passive Perception of 14 (10 + 2 for your Wisdom modifier + 2 for proficiency).
...
![Level 1 Hit Points by Class](Mechanics/CLI/tables/level-1-hit-points-by-class-xphb.md)

The character sheet includes room to note your current Hit Points when you take damage, as well as any [Temporary Hit Points](Mechanics/CLI/rules/variant-rules/temporary-hit-points-xphb.md) you might gain. There's also space to track [Death Saving Throws](Mechanics/CLI/rules/variant-rules/death-saving-throw-xphb.md).
...
Without armor or a shield, your base [Armor Class](Mechanics/CLI/rules/variant-rules/armor-class-xphb.md) is 10 plus your Dexterity modifier. If your starting equipment includes armor or a Shield (or both), calculate your AC using the rules in "chapter 6". A class feature might give you a different way to calculate your AC.
...
![Adventuring equipment impr...](Mechanics/CLI/books/players-handbook-2024/img/021-02-010-adventuring-equipment.webp#center "Adventuring equipment improves as a character progresses through the tiers of play")

While going on adventures, your character gains experience, represented by [Experience Points](Mechanics/CLI/rules/variant-rules/experience-points-xphb.md) (XP). A character who reaches a specified Experience Point total advances in capability. This advancement is called gaining a level.
...
![Level Advancement; Character Advancement](Mechanics/CLI/tables/level-advancement-character-advancement-xphb.md)
...
In tier 2, characters are full-fledged adventurers. Spellcasters gain iconic spells such as [Fireball](Mechanics/CLI/spells/fireball-xphb.md), [Lightning Bolt](Mechanics/CLI/spells/lightning-bolt-xphb.md), and [Raise Dead](Mechanics/CLI/spells/raise-dead-xphb.md). Most weapon-focused classes gain the ability to make multiple attacks in a round. The characters now face dangers that threaten cities and kingdoms.
...
![Starting Equipment at Higher Levels](Mechanics/CLI/tables/starting-equipment-at-higher-levels-xphb.md)
...
If you have multiple ways to calculate your [Armor Class](Mechanics/CLI/rules/variant-rules/armor-class-xphb.md), you can benefit from only one at a time. For example, a Monk/Sorcerer with a Monk's Unarmored Defense feature and a Sorcerer's Draconic Resilience feature must choose only one of those features as a way to calculate Armor Class.
...
![Spellcasting; Multiclass Spellcaster: Spell Slots per Spell Level](Mechanics/CLI/tables/spellcasting-multiclass-spellcaster-spell-slots-per-spell-level-xphb.md)
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [Burning Hands](Mechanics/CLI/spells/burning-hands-xphb.md), has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
...
![A character with Paladin a...](Mechanics/CLI/books/players-handbook-2024/img/022-02-011-paladin-warlock-multiclass.webp#center "A character with Paladin and Warlock levels might call on both a mighty oath and an otherworldly patron")

## Trinkets

When you make your character, you can roll once on the [Trinkets](Mechanics/CLI/items/trinket-xphb.md) table to gain a Tiny trinket, a simple item lightly touched by mystery. The DM might also use this table. It can help stock a room in a dungeon or fill a creature's pockets.